...
public class KillAuraCheck extends Check {
    ...
    public void onDamage(EntityDamageByEntityEvent event) {
        ...
        // Conservative snap check
        if (yawDelta > 120 && timeDiff < 80) {
        ...
        // Very conservative: lots of legit cases can exceed 90 under lag/knockback.
        if (angle > 140) {
        ...
        if (history.size() > 25) {
            ...
            if (variance < 0.2 && history.size() == 25) {
